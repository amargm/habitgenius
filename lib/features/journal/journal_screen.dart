          ...
          children: [
            ...
            Expanded(
              child: sorted.isEmpty
                  ? _EmptyJournal(hasSearch: _search.isNotEmpty)
                  : ListView.separated(
                      padding:
...
class _JournalEntrySheetState
    extends ConsumerState<_JournalEntrySheet> {
...
class _EmptyJournal extends StatelessWidget {
  ...
  const _EmptyJournal({required this.hasSearch});
  ...
  Widget build(BuildContext context) => Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              hasSearch ? 'No matching entries' : 'No journal entries yet',
              style: const TextStyle(
